...
| Delivery fit | The file type and aspect ratio are acceptable for the request | Convert only when the user requested a specific format/size or the artifact cannot be used as delivered |
